...
const {   getCategories,  addCategory,  updateCategory,  getCategory,  deleteCategory, getCategoryDetail,} = require("../controllers/category");
const {   getProfiles, addProfile, updateProfile, getProfile } = require("../controllers/profile");
...
router.get("/profile", auth, getProfile); //curious
